...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("clusterlocalizations"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Apps().V1alpha1().ClusterLocalizations().Informer()}, nil
	...
	case v1alpha1.SchemeGroupVersion.WithResource("manifests"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Apps().V1alpha1().Manifests().Informer()}, nil
