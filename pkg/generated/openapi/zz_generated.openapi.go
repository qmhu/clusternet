...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/clusternet/clusternet/pkg/apis/federations/v1alpha1.Govern": schema_pkg_apis_federations_v1alpha1_Govern(ref),
...
func schema_pkg_apis_federations_v1alpha1_Govern(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Govern is the query path for managing federation apps",
				Type:        []string{"object"},
